...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ClubProfileWidget.routeName,
          path: ClubProfileWidget.routePath,
          builder: (context, params) => ClubProfileWidget(
        ...
        FFRoute(
          ...
          path: MembershipCardWidget.routePath,
          builder: (context, params) => MembershipCardWidget(
        ...
        FFRoute(
          name: FindClubsWidget.routeName,
          path: FindClubsWidget.routePath,
          builder: (context, params) => FindClubsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AddSessionWidget.routeName,
          path: AddSessionWidget.routePath,
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/BSC_-_Splash.png',
                    fit: BoxFit.fill,
                  ),
                )
              : page;
